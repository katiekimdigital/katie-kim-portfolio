  ...
  return (
    <div className={styles.panel}>
      ...
      <div className={styles.columns}>
        <p>
          <span className={styles.dropCap}>W</span>elcome to the café. The menu changes with what I'm making. This week's specialties are mostly case studies — four pieces showing how I direct AI as a production team while the strategic work stays human.
        </p>
        <p>
        ...
        <p>
          Sydney-based, working remotely with founders and teams around the world who want the speed of AI without the blandness of generic AI output. The craft still comes first. Everything else is leverage.
        </p>
        <p>
